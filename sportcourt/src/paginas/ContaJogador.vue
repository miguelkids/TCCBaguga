  ...
  <div class="sc-page">
    ...
    <main class="sc-container-sm sc-main sc-main-padded">
      ...
      <div class="sc-card" style="padding: 32px;">
        ...
        <div style="margin-top: 24px; border-top: 1px solid var(--sc-border); padding-top: 20px; display: flex; flex-direction: column; gap: 10px;">
          <button class="sc-btn sc-btn-sm" style="width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px; min-height: 44px; border-radius: var(--sc-radius);" @click="$router.push('/minhas-reservas')">
