...
<template>
  <div class="cadastro">
    ...
    <form @submit.prevent="handleCadastro">
      ...
      <input v-model="usuario" placeholder="Nome de usuário" required>
      <input v-model="telefone" placeholder="Telefone" type="tel">
      <input v-model="email" placeholder="Email" type="email" required>
      <input v-model="senha" placeholder="Senha" type="password" required>
...
export default {
  data() {
    return { nome:"", usuario:"", telefone:"", email:"", senha:"" };
  },
  methods: {
