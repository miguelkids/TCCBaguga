<template>
  <div class="pagina-cadastro">
    ...
    <!-- Header -->
    <header class="header">
      <router-link to="/escolher-perfil" id="btn-voltar-dono" class="btn-voltar">
          ...
          <form @submit.prevent="handleCadastro" class="formulario">
            ...
            <div class="campo">
              ...
              <div class="input-wrapper">
                ...
                <input id="input-nome-dono" type="text" v-model="nome" placeholder="Seu nome completo" required class="input-campo" />
              </div>
            </div>
            ...
            <div class="campo">
              ...
              <div class="input-wrapper">
                ...
                <input id="input-usuario-dono" type="text" v-model="usuario" placeholder="seuusuario" required class="input-campo input-campo--usuario" />
              </div>
            </div>
            ...
            <div class="campo">
              ...
              <div class="input-wrapper">
                ...
                <input id="input-telefone-dono" type="text" v-model="telefone" placeholder="(00) 00000-0000" class="input-campo" />
              </div>
            </div>
            ...
            <div class="campo">
              ...
              <div class="input-wrapper">
                ...
                <input id="input-email-dono" type="email" v-model="email" placeholder="seu@email.com" required class="input-campo" />
              </div>
            </div>
            ...
            <div class="campo">
              ...
              <div class="input-wrapper">
                ...
                <input id="input-senha-dono" type="password" v-model="senha" placeholder="••••••••" required class="input-campo" />
              </div>
            </div>

            <button id="btn-cadastrar-dono" type="submit" :disabled="carregando" class="btn-submit">
