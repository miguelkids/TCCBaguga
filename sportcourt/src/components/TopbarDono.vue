<template>
  <header class="topbar">
    <div class="topbar__inner">
      <router-link to="/confirmar-quadra" class="topbar__logo">
        <img :src="logo" alt="SportCourt" class="topbar__logo-img" />
        <span class="topbar__logo-texto">SportCourt</span>
      </router-link>

      <nav class="topbar__nav">
        <router-link to="/minhas-quadras" class="topbar__link" active-class="topbar__link--ativo">Quadras</router-link>
        <router-link to="/reservas" class="topbar__link" active-class="topbar__link--ativo">Reservas</router-link>
        <router-link to="/faturamento-dono" class="topbar__link" active-class="topbar__link--ativo">Dashboard</router-link>
        <router-link to="/perfil" class="topbar__link" active-class="topbar__link--ativo">Perfil</router-link>
      </nav>

      <!-- Hamburger mobile -->
      <button class="topbar__hamburger" @click="menuAberto = !menuAberto" aria-label="Menu">
    ...
    <!-- Dropdown mobile -->
    <div class="topbar__dropdown" v-show="menuAberto" @click="menuAberto = false">
      <router-link to="/minhas-quadras" class="topbar__dropdown-item" active-class="topbar__dropdown-item--ativo">
      ...
      <router-link to="/reservas" class="topbar__dropdown-item" active-class="topbar__dropdown-item--ativo">
      ...
      <router-link to="/faturamento-dono" class="topbar__dropdown-item" active-class="topbar__dropdown-item--ativo">
      ...
      <router-link to="/perfil" class="topbar__dropdown-item" active-class="topbar__dropdown-item--ativo">
